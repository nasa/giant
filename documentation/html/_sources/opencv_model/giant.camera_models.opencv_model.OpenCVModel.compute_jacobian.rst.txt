...
.. automethod:: OpenCVModel.compute_jacobian


Example::

    >>> from giant.camera_models import OpenCVModel
    >>> model = OpenCVModel(fx=3000, fy=4000, px=500, py=500, a1=1e-5, a2=1e-6,
...
.. math::
    ...
    \begin{split}
    \frac{\partial\mathbf{x}_I'}{\partial\mathbf{x}_I} = &\frac{u}
    {l}\mathbf{I}_{2\times 2} +
    \left[\begin{array}{cc}2p_1y_I+4p_2x_I & 2p_1x_I \\
    2p_2y_I & 4p_1y_I+2p_2x_I \end{array}\right] + \\
    & \frac{l\left(2k_1+4k_2r^2+6k_3r^4\right)-
    u\left(2k_4+4k_5r^2+6k_6r^4\right)}
    {l^2}\mathbf{x}_I\mathbf{x}_I^T +\\
